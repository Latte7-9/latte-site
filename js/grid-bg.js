// Grid Animation for Latte - main page background
// Adapted from Tomotoes/HomePage
...
// Initialize grid when main content is shown
window.initGridBackground = function() {
  var canvas = document.getElementById('gridCanvas');
  if (!canvas || window._gridInitialized) return;
  window._gridInitialized = true;
  ...
  setTimeout(function() {
    var gridAnimation = new GridAnimation(canvas, {
      ...
      hoverFillColor: 'rgba(41, 144, 192, 0.5)',
      hoverShadowColor: 'rgba(41, 144, 192, 0.2)',
      transitionDuration: isPhone ? 150 : 200,
      trailDuration: isPhone ? 2000 : 1500,
      specialBlockColor: 'rgba(100, 200, 160, 0.7)',
      specialHoverColor: 'rgba(41, 200, 144, 0.7)',
      snakeHeadColor: 'rgba(41, 144, 192, 0.9)',
      snakeTailColor: 'rgba(41, 144, 192, 0.15)',
